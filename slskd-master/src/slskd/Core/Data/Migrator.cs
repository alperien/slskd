...
public class Migrator
{
    ...
    public Migrator(ConnectionStringDictionary databases)
    {
        ...
        Migrations = new()
        {
            ...
            { nameof(Z2026_06_29_TransferAutoReplaceMigration), new Z2026_06_29_TransferAutoReplaceMigration(connectionStrings: Databases) },
            { nameof(Z2026_07_03_TransferMetadataMigration), new Z2026_07_03_TransferMetadataMigration(connectionStrings: Databases) },
        };
    }
