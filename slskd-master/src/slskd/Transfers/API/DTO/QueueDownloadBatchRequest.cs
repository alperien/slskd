...
public record EnqueueDownloadBatchItem
{
    ...
    /// <summary>
    ///     The optional audio bitrate, in kilobits per second.
    /// </summary>
    public int? BitRate { get; init; }

    /// <summary>
    ///     The optional audio bit depth.
    /// </summary>
    public int? BitDepth { get; init; }

    /// <summary>
    ///     The optional audio length, in seconds.
    /// </summary>
    public int? Length { get; init; }

    /// <summary>
    ///     The optional audio sample rate, in hertz.
    /// </summary>
    public int? SampleRate { get; init; }

    /// <summary>
    ///     A value indicating whether the audio bitrate is variable.
    /// </summary>
