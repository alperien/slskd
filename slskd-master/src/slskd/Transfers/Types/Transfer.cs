...
public class Transfer
{
    ...
    /// <summary>
    ///     Gets or sets the audio bitrate, if known.
    /// </summary>
    public int? BitRate { get; set; }

    /// <summary>
    ///     Gets or sets the audio bit depth (e.g. 16 or 24), if known.
    /// </summary>
    public int? BitDepth { get; set; }

    /// <summary>
    ///     Gets or sets the track length in seconds, if known.
    /// </summary>
    public int? Length { get; set; }

    /// <summary>
    ///     Gets or sets the audio sample rate (e.g. 44100), if known.
    /// </summary>
    public int? SampleRate { get; set; }

    /// <summary>
    ///     Gets or sets a value indicating whether the audio is variable bitrate, if known.
    /// </summary>
