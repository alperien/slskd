...
public partial class DownloadServiceTests
{
    ...
    private static (DownloadService service, Mocks mocks) GetFixture(
        ...
        Batch batch = null,
        Search search = null,
        bool autoReplaceEnabled = false)
    {
        var mocks = new Mocks(subdirectory, batch, search, autoReplaceEnabled);
    ...
    private class Mocks
    {
        public Mocks(string subdirectory = null, Batch batch = null, Search search = null, bool autoReplaceEnabled = false)
        {
            OptionsMonitor = new TestOptionsMonitor<Options>(new Options
            {
                Transfers = new Options.TransfersOptions
                {
                    Download = new Options.TransfersOptions.GlobalDownloadOptions
                    {
                        ...
                        AutoReplace = new Options.TransfersOptions.GlobalDownloadOptions.AutoReplaceOptions
                        {
                            Enabled = autoReplaceEnabled,
                        },
                    }
                }
            });
